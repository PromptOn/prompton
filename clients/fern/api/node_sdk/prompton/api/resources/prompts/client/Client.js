...
class Prompts {
    ...
    getPromptById(id) {
        return __awaiter(this, void 0, void 0, function* () {
            const _response = yield core.fetcher({
                url: (0, url_join_1.default)(yield core.Supplier.get(this.options.environment), `prompts/${id}`),
                method: "GET",
                headers: {
                    Authorization: yield this._getAuthorizationHeader(),
                    "X-Fern-Language": "JavaScript",
            ...
            if (_response.ok) {
                return yield serializers.PromptRead.parseOrThrow(_response.body, {
                    unrecognizedObjectKeys: "passthrough",
                    allowUnrecognizedUnionMembers: true,
                    allowUnrecognizedEnumValues: true,
                    breadcrumbsPrefix: ["response"],
    ...
    updatePrompt(id, request = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            const _response = yield core.fetcher({
                ...
                contentType: "application/json",
                body: yield serializers.PromptUpdate.jsonOrThrow(request, { unrecognizedObjectKeys: "strip" }),
                timeoutMs: 60000,
            });
            if (_response.ok) {
                return yield serializers.PromptRead.parseOrThrow(_response.body, {
